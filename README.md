...
4. Copy the [.mez file](https://github.com/kerski/powerquery-connector-pbi-rest-api-gcchigh/blob/main/bin/AnyCPU/Debug/powerquery-connector-pbi-rest-api-gcc.mez?raw=true) to your folder "Documents\Power BI Desktop\Custom Connectors".  If the folder does not exist create it first.
