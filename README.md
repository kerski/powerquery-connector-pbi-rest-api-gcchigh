...
4. Copy the [.mez file](https://github.com/kerski/powerquery-connector-pbi-rest-api-gcchigh/releases/download/v.1.0.0-beta/powerquery-connector-pbi-rest-api-gcchigh.mez) to your folder "Documents\Power BI Desktop\Custom Connectors".  If the folder does not exist create it first.
5. Open Power BI Desktop
6. Select Get Data option.
7. Navigate to the "Other" section and you should see the "Connect to Power BI REST API in GCC (High)" connector.
